                ...
                <div className="flex justify-center items-center mt-16 gap-y-6">
                    <div className="flex flex-col justify-start items-center p-4 gap-y-8">
                        ...
                        <div className="rounded-lg flex flex-col w-full overflow-hidden">
                            <div
                                className="px-4 py-6 bg-white last:border-none border-b border-gray-200 flex items-center justify-between flex-wrap gap-3">
                                ...
                                <div className="flex items-center gap-1">
                                    <div
                                        className="p-2 rounded-lg flex justify-center items-center gap-2.5">
                                        <svg
