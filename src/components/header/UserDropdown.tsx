            ...
            >
                <span className="mr-1 overflow-hidden rounded-full h-12 w-12">
                    <Image
                        ...
                        alt="User"
                        className={`p-0.5 border-2 rounded-full ${isOpen ? "border-blue-400" : "border-gray-200"}`}
                    />
                </span>

                <svg
                    className={`stroke-gray-500 w-3 h-3 dark:stroke-gray-400 transition-transform duration-200 ${
                        isOpen ? "rotate-180" : ""
                    }`}
